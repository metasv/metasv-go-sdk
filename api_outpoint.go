 ...
 */
func (a *OutpointApiService) VinTxidDetailGet(ctx _context.Context, txid string) ApiVinTxidDetailGetRequest {
	return ApiVinTxidDetailGetRequest{
		ApiService: a,
		ctx:        ctx,
		txid:       txid,
 ...
 */
func (a *OutpointApiService) VinTxidDetailGetExecute(r ApiVinTxidDetailGetRequest) ([]OutputInfoDetail, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OutpointApiService.VinTxidDetailGet")
	if err != nil {
		executionError.error = err.Error()
		return localVarReturnValue, nil, executionError
	}
