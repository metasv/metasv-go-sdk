...
// APIClient manages communication with the MetaSV API Spec API v2.1.4
...
type APIClient struct {
	...
	SensibleApi *SensibleApiService

	TxApi *TxApiService

	UserApi *UserApiService

	XpubApi *XpubApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.SensibleApi = (*SensibleApiService)(&c.common)
