...
type ApiMerchantBroadcastPostRequest struct {
	ctx        _context.Context
	ApiService *MerchantApiService
	txRaw      *TxRaw
}

func (r ApiMerchantBroadcastPostRequest) TxRaw(txRaw TxRaw) ApiMerchantBroadcastPostRequest {
	r.txRaw = &txRaw
	return r
}

func (r ApiMerchantBroadcastPostRequest) Execute() (BroadcastResult, *_nethttp.Response, GenericOpenAPIError) {
	return r.ApiService.MerchantBroadcastPostExecute(r)
}

/*
 * MerchantBroadcastPost Broadcast tx to coorperated miner merchant APIs(TAAL).
 * This api will broadcast to taal, you can broadcast tx with fee rate 0.25 sat/b by this api
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiMerchantBroadcastPostRequest
 */
func (a *MerchantApiService) MerchantBroadcastPost(ctx _context.Context) ApiMerchantBroadcastPostRequest {
	return ApiMerchantBroadcastPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
 ...
 */
func (a *MerchantApiService) MerchantBroadcastPostExecute(r ApiMerchantBroadcastPostRequest) (BroadcastResult, *_nethttp.Response, GenericOpenAPIError) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MerchantApiService.MerchantBroadcastPost")
	if err != nil {
		executionError.error = err.Error()
		return localVarReturnValue, nil, executionError
	}

	localVarPath := localBasePath + "/merchant/broadcast"
