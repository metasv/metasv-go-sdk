...
// SensibleNftSellUtxo Sensible nft sell Utxo belongs to the specified address
type SensibleNftSellUtxo struct {
...
func (o SensibleNftSellUtxo) MarshalJSON() ([]byte, error) {
...
type NullableSensibleNftSellUtxo struct {
	value *SensibleNftSellUtxo
	isSet bool
}

func (v NullableSensibleNftSellUtxo) Get() *SensibleNftSellUtxo {
	return v.value
}

func (v *NullableSensibleNftSellUtxo) Set(val *SensibleNftSellUtxo) {
	v.value = val
	v.isSet = true
}

func (v NullableSensibleNftSellUtxo) IsSet() bool {
	return v.isSet
}

func (v *NullableSensibleNftSellUtxo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSensibleNftSellUtxo(val *SensibleNftSellUtxo) *NullableSensibleNftSellUtxo {
	return &NullableSensibleNftSellUtxo{value: val, isSet: true}
}

func (v NullableSensibleNftSellUtxo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSensibleNftSellUtxo) UnmarshalJSON(src []byte) error {
	v.isSet = true
